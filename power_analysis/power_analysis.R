...
write.table(Results, "power_analysis/power_results.txt", quote = T, row.names = F)
...
ggsave(filename="power_analysis/ggplot_power.pdf", 
       plot = power_plot, 
       device = cairo_pdf, 
       width = 400, 
       height = 297, 
...
ggsave(filename="power_analysis/ggplot_power.png", 
       plot = power_plot, 
       device = png, 
       width = 400, 
       height = 297, 
